...
namespace EAddonsEditor\Modules\Site\Tags;
...
class Field extends Base_Tag {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                'tag_field',
                [
                    'label' => __('Option', 'elementor'),
                    'type' => 'e-query',
                    'placeholder' => __('Options key', 'elementor'),
                    'label_block' => true,
                    'query_type' => 'options',
                    'description' => __('Search global value from the Options', 'elementor').'<br><a target="_blank" href="'.admin_url('options.php').'">'.__('See all Options', 'elementor').'</a>',
                ]
        );
