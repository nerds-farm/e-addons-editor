...
class Password extends Base_Tag {

    public function get_name() {
        return 'e-tag-user-password';
    }
    
    public function get_icon() {
        return 'eadd-dynamic-tag-user-lostpasswordurl';
    }
    ...
    public function get_title() {
        return __('User Lost Password URL', 'e-addons');
    }
    ...
    public function render() {
        ...
        $link = esc_url( wp_lostpassword_url($redirect) );
