...
class Logout extends Base_Tag {

    public function get_name() {
        return 'e-tag-user-logout';
    }
   
    public function get_icon() {
        return 'eadd-dynamic-tag-user-logouturl';
    }
    ...
    public function get_title() {
        return __('User Logout URL', 'e-addons');
    }
    ...
    public function render() {
        ...
        $link = esc_url( wp_logout_url($redirect) );
